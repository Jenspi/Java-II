...
public class SortersTester {
  ...
  /**
   instantiates our Dog objects and adds them to a list for testing
  */
  @Before
  public void setup() {
  ...
  /**
   a method that sorts a list; for testing that a list being put out by our method(s) is truly sorted
  */
  ...
  */
  ...
  /**
   tests our selectionSort() method
  */
  @Test
  ...
  /**
   tests our mergeSort() method, invoking our recursiveMergeSortHelper() method
  */
  @Test
  ...
  /**
   tests our indexOf() method, which calls our recursiveBinarySearcher() method
  */
  @Test
