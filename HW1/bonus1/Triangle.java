...
public class Triangle extends Shape
{
	...
	*/
	...
	/**
	 overriden method from the Shape class that returns the height
	 of a given Triangle object
	...
	*/
	...
	/**
	 overriden equals method from the Object class that measures
	 equality based on the height and base of a Triangle object
	*/
	@Override
	public boolean equals(Object o){
		...
		if (o instanceof Triangle) {
            ...
            if (Math.abs(this.getHeight() - other.getHeight()) < 0.01 && Math.abs(this.getBase() - other.getBase()) < 0.01){
                equal = false;
            }
        }
        return equal;
